...
export default function AppStoreBadges() {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-6">
      {/* Google Play */}
      <div className="flex items-center gap-2.5 rounded-xl bg-[#f6f3f2] px-5 py-2.5 opacity-60">
        <svg className="w-6 h-6 text-[#4f4f4f]" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div>
          ...
          <p className="text-xs text-[#4f4f4f] font-bold">{fr ? "Bient\u00f4t" : "Coming"} Sept 2026</p>
        </div>
      </div>
      {/* App Store */}
      <div className="flex items-center gap-2.5 rounded-xl bg-[#f6f3f2] px-5 py-2.5 opacity-60">
